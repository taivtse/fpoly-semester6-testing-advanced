...
public class AbstractServiceImpl<ID extends Serializable, D, E> implements GenericService<ID, D> {
    protected GenericConverter<D, E> converter;
    protected GenericDao<ID, E> genericDao;

    AbstractServiceImpl(GenericDao genericDao, GenericConverter genericConverter) {
    ...
    public List<D> findAll(Pageable pageable) {
        List<E> entityList = genericDao.findAll(pageable);
