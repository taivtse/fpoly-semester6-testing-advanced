...
User: vothanhtai - Date: 3/26/19 - Time: 20:44
--%>
    ...
    <script>
        ...
        function sendName() {
            if (chatNum == 1) {
                ...
                stompClient.send("/app/xinchao", {}, JSON.stringify({'name': $("#name").val()}));
            }
        }
        ...
        <div class="col-md-6">
            <form class="form-inline">
                <div class="form-group">
                    <label for="connect1">WebSocket connection:</label>
